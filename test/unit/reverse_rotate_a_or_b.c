...
/*   Updated: 2023/02/14 11:58:55 by yena             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	reverse_rotate_a_or_b_test(void)
{
	...
	init_stack(&a, &b, argv);
	ft_printf("============ command: rra ============\n");
	ft_printf("stack a: 1 4 2 3 -1 0 \tstack b: \n");
	ft_printf("from reverse_rotate_a_or_b(): ");
	...
	ft_printf("\n\n============ command: rrb ============\n");
	ft_printf("stack a: 0 1 4 2 3 -1 \tstack b: \n");
	ft_printf("from reverse_rotate_a_or_b(): must do nothing\n");
