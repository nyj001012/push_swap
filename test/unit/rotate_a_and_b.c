...
/*   Updated: 2023/02/14 13:54:31 by yena             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_a_and_b_test(void)
{
	...
	init_stack(&a, &b, argv);
	ft_printf("============ command: rr ============\n");
	ft_printf("stack a: 1 4 2 3 -1 0 \tstack b: \n");
	ft_printf("from rotate_a_and_b(): ");
	rotate_a_and_b(&a, &b);
	...
	push_a_or_b(&a, &b, PB);
	push_a_or_b(&a, &b, PB);
	ft_printf("stack a: 3 -1 0 1 \tstack b: 2 4 \n");
	ft_printf("from rotate_a_and_b(): ");
	rotate_a_and_b(&a, &b);
	ft_printf("expected => stack a: -1 0 1 3 \tstack b: 4 2\n");
	ft_printf("result   => stack a: ");
	a_head_node = a.head_node;
	while (a_head_node)
	{
	...
	push_a_or_b(&a, &b, PB);
	push_a_or_b(&a, &b, PB);
	ft_printf("stack a: \tstack b: 3 1 0 -1 4 2 \n");
	ft_printf("from rotate_a_and_b(): ");
	rotate_a_and_b(&a, &b);
	ft_printf("expected => stack a: \tstack b: 1 0 -1 4 2 3\n");
	ft_printf("result   => stack a: ");
	a_head_node = a.head_node;
	while (a_head_node)
	{
