...
void	swap_a_or_b_test(void)
{
	...
	init_stack(&a, &b, argv);
	ft_printf("============ command: sa ============\n");
	ft_printf("stack a: 1 4 2 3 -1 0 \tstack b: \n");
	ft_printf("from swap_a_or_b(): ");
	swap_a_or_b(&a, SA);
	ft_printf("expected => stack a: 4 1 2 3 -1 0 \tstack b: \n");
	...
	ft_printf("\n\n============ command: sb ============\n");
	ft_printf("stack a: 4 1 2 3 -1 0 \tstack b: \n");
	...
	ft_printf("from swap_a_or_b(): must do nothing\n");
	swap_a_or_b(&b, SB);
	ft_printf("expected => stack a: 1 2 3 -1 0 \tstack b: 4 \n");
	ft_printf("result   => stack a: ");
	a_head_node = a.head_node;
	while (a_head_node)
	{
	...
	ft_printf("from swap_a_or_b(): ");
	swap_a_or_b(&b, SB);
	ft_printf("expected => stack a: 2 3 -1 0 \tstack b: 4 1 \n");
	ft_printf("result   => stack a: ");
	a_head_node = a.head_node;
	while (a_head_node)
	{
